...
fork of https://github.com/vapor-ware/fastapi-rfc7807
"""
...
import libs.web_service.schemas as schema
    ...
    if add_schema:
        ...
        def wrap_openapi() -> Dict:
            ...
            if pydantic.__version__.startswith('2.'):
                problem_schema = {name: schema.Problem.model_json_schema(by_alias=True)}
            else:
                problem_schema = {name: schema.Problem.schema(by_alias=True)}

            app.openapi_schema.setdefault('components', {}).setdefault('schemas', {}).update(problem_schema,)
